...
This automatically generates fresh tokens for all 3 test users and updates your environment variables. See [Token Automation Documentation](token_automation.md) for detailed setup instructions.

#### Manual Token Generation (Alternative)

If you prefer manual token generation:
...
Firebase JWT tokens expire after 1 hour. When tokens expire, simply refresh them:
