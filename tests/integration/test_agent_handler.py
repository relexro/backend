...
from functions.src.agent_handler import AgentHandler
from functions.src.agent_tools import DatabaseError
...
async def test_handle_user_input_success(sample_case_state, sample_agent_response):
    ...
    with patch("google.cloud.firestore_v1.AsyncClient") as mock_firestore, \
         patch("functions.src.agent_handler.create_agent_graph") as mock_create_graph:
...
async def test_handle_payment_webhook_success():
    ...
    with patch("google.cloud.firestore_v1.AsyncClient") as mock_firestore, \
         patch("functions.src.agent_handler.verify_payment") as mock_verify_payment:
