...
async def test_concurrent_processing():
    ...
    with patch("functions.src.llm_integration.get_case_details") as mock_get_case, \
         patch("functions.src.llm_integration.update_case_details") as mock_update_case:
...
async def test_draft_generation_state():
    ...
    with patch("functions.src.llm_integration.update_case_details") as mock_update_case, \
         patch("functions.src.llm_integration.process_legal_query") as mock_process:
...
async def test_node_transition_success():
    ...
    with patch("functions.src.llm_integration.update_case_details") as mock_update:
        initial_state = {
            "case_id": "case_123",
